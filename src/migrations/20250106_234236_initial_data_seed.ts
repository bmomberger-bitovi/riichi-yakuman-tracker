...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_yakuman_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__yakuman_v_version_status" AS ENUM('draft', 'published');
  ...
  CREATE TABLE IF NOT EXISTS "yakuman" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "enum_yakuman_status" DEFAULT 'draft'
  );
  
  CREATE TABLE IF NOT EXISTS "yakuman_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_yakuman_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_title" varchar,
  	...
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"version__status" "enum__yakuman_v_version_status" DEFAULT 'draft',
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"latest" boolean,
  	"autosave" boolean
  ...
  CREATE TABLE IF NOT EXISTS "_yakuman_v_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "yakuman_achievements" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"yakuman_id" integer NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "payload_locked_documents_rels" (
  	...
  	"pages_id" integer,
  	"yakuman_id" integer,
  	"yakuman_achievements_id" integer,
  	"media_id" integer,
  	"categories_id" integer,
  	"users_id" integer,
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_rels" ADD CONSTRAINT "pages_rels_yakuman_fk" FOREIGN KEY ("yakuman_id") REFERENCES "public"."yakuman"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_rels" ADD CONSTRAINT "_pages_v_rels_yakuman_fk" FOREIGN KEY ("yakuman_id") REFERENCES "public"."yakuman"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "yakuman" ADD CONSTRAINT "yakuman_hero_image_id_media_id_fk" FOREIGN KEY ("hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "yakuman" ADD CONSTRAINT "yakuman_meta_image_id_media_id_fk" FOREIGN KEY ("meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "yakuman_rels" ADD CONSTRAINT "yakuman_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."yakuman"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "yakuman_rels" ADD CONSTRAINT "yakuman_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_yakuman_v" ADD CONSTRAINT "_yakuman_v_parent_id_yakuman_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."yakuman"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_yakuman_v" ADD CONSTRAINT "_yakuman_v_version_hero_image_id_media_id_fk" FOREIGN KEY ("version_hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_yakuman_v" ADD CONSTRAINT "_yakuman_v_version_meta_image_id_media_id_fk" FOREIGN KEY ("version_meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_yakuman_v_rels" ADD CONSTRAINT "_yakuman_v_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."_yakuman_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_yakuman_v_rels" ADD CONSTRAINT "_yakuman_v_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "yakuman_achievements" ADD CONSTRAINT "yakuman_achievements_yakuman_id_yakuman_id_fk" FOREIGN KEY ("yakuman_id") REFERENCES "public"."yakuman"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "redirects_rels" ADD CONSTRAINT "redirects_rels_yakuman_fk" FOREIGN KEY ("yakuman_id") REFERENCES "public"."yakuman"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "search_rels" ADD CONSTRAINT "search_rels_yakuman_fk" FOREIGN KEY ("yakuman_id") REFERENCES "public"."yakuman"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_yakuman_fk" FOREIGN KEY ("yakuman_id") REFERENCES "public"."yakuman"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_yakuman_achievements_fk" FOREIGN KEY ("yakuman_achievements_id") REFERENCES "public"."yakuman_achievements"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "header_rels" ADD CONSTRAINT "header_rels_yakuman_fk" FOREIGN KEY ("yakuman_id") REFERENCES "public"."yakuman"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "footer_rels" ADD CONSTRAINT "footer_rels_yakuman_fk" FOREIGN KEY ("yakuman_id") REFERENCES "public"."yakuman"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_rels_yakuman_id_idx" ON "pages_rels" USING btree ("yakuman_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_rels_yakuman_id_idx" ON "_pages_v_rels" USING btree ("yakuman_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_rels_categories_id_idx" ON "_pages_v_rels" USING btree ("categories_id");
  CREATE INDEX IF NOT EXISTS "yakuman_hero_image_idx" ON "yakuman" USING btree ("hero_image_id");
  CREATE INDEX IF NOT EXISTS "yakuman_meta_meta_image_idx" ON "yakuman" USING btree ("meta_image_id");
  CREATE INDEX IF NOT EXISTS "yakuman_slug_idx" ON "yakuman" USING btree ("slug");
  CREATE INDEX IF NOT EXISTS "yakuman_updated_at_idx" ON "yakuman" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "yakuman_created_at_idx" ON "yakuman" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "yakuman__status_idx" ON "yakuman" USING btree ("_status");
  CREATE INDEX IF NOT EXISTS "yakuman_rels_order_idx" ON "yakuman_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "yakuman_rels_parent_idx" ON "yakuman_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "yakuman_rels_path_idx" ON "yakuman_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "yakuman_rels_categories_id_idx" ON "yakuman_rels" USING btree ("categories_id");
  CREATE INDEX IF NOT EXISTS "_yakuman_v_parent_idx" ON "_yakuman_v" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_yakuman_v_version_version_hero_image_idx" ON "_yakuman_v" USING btree ("version_hero_image_id");
  CREATE INDEX IF NOT EXISTS "_yakuman_v_version_meta_version_meta_image_idx" ON "_yakuman_v" USING btree ("version_meta_image_id");
  CREATE INDEX IF NOT EXISTS "_yakuman_v_version_version_slug_idx" ON "_yakuman_v" USING btree ("version_slug");
  CREATE INDEX IF NOT EXISTS "_yakuman_v_version_version_updated_at_idx" ON "_yakuman_v" USING btree ("version_updated_at");
  CREATE INDEX IF NOT EXISTS "_yakuman_v_version_version_created_at_idx" ON "_yakuman_v" USING btree ("version_created_at");
  CREATE INDEX IF NOT EXISTS "_yakuman_v_version_version__status_idx" ON "_yakuman_v" USING btree ("version__status");
  CREATE INDEX IF NOT EXISTS "_yakuman_v_created_at_idx" ON "_yakuman_v" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "_yakuman_v_updated_at_idx" ON "_yakuman_v" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "_yakuman_v_latest_idx" ON "_yakuman_v" USING btree ("latest");
  CREATE INDEX IF NOT EXISTS "_yakuman_v_autosave_idx" ON "_yakuman_v" USING btree ("autosave");
  CREATE INDEX IF NOT EXISTS "_yakuman_v_rels_order_idx" ON "_yakuman_v_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "_yakuman_v_rels_parent_idx" ON "_yakuman_v_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_yakuman_v_rels_path_idx" ON "_yakuman_v_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "_yakuman_v_rels_categories_id_idx" ON "_yakuman_v_rels" USING btree ("categories_id");
  CREATE INDEX IF NOT EXISTS "yakuman_achievements_yakuman_idx" ON "yakuman_achievements" USING btree ("yakuman_id");
  CREATE INDEX IF NOT EXISTS "yakuman_achievements_updated_at_idx" ON "yakuman_achievements" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "yakuman_achievements_created_at_idx" ON "yakuman_achievements" USING btree ("created_at");
  ...
  CREATE INDEX IF NOT EXISTS "redirects_rels_yakuman_id_idx" ON "redirects_rels" USING btree ("yakuman_id");
  ...
  CREATE INDEX IF NOT EXISTS "search_rels_yakuman_id_idx" ON "search_rels" USING btree ("yakuman_id");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_yakuman_id_idx" ON "payload_locked_documents_rels" USING btree ("yakuman_id");
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_yakuman_achievements_id_idx" ON "payload_locked_documents_rels" USING btree ("yakuman_achievements_id");
  ...
  CREATE INDEX IF NOT EXISTS "header_rels_yakuman_id_idx" ON "header_rels" USING btree ("yakuman_id");
  ...
  CREATE INDEX IF NOT EXISTS "footer_rels_yakuman_id_idx" ON "footer_rels" USING btree ("yakuman_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "yakuman" CASCADE;
  DROP TABLE "yakuman_rels" CASCADE;
  DROP TABLE "_yakuman_v" CASCADE;
  DROP TABLE "_yakuman_v_rels" CASCADE;
  DROP TABLE "yakuman_achievements" CASCADE;
  ...
  DROP TYPE "public"."enum_yakuman_status";
  DROP TYPE "public"."enum__yakuman_v_version_status";
